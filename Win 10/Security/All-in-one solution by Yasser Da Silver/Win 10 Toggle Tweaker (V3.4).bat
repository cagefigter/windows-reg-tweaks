@echo off
Color 1F
Title Windows 10 Toggle Tweaker V3.4 By Yasser Da Silva
set CurV=3.4
...
echo strFileURL = "https://drive.google.com/uc?export=download&id=0B_Y-lCJYwHfiU3ZHbjRUQ0hHMVk" > TWV.vbs
...
echo   3. Enable/Disable stuff In Windows 10             บAบ  Hide Remove Hardware Icon  บ
echo   4. Speed Up PC Performance                        ศอน            3=^>13            บ
echo   5. Manage Microsoft Edge browser                  ษอฮอออออออออออออออออออออออออออออน
echo   6. Manage Updates                                 บBบ Disable Javascript in Edge  บ
echo   7. Manage Windows Features                        ศอน            5=^>12            บ
echo   8. Manage User Accounts                           ษอฮอออออออออออออออออออออออออออออน
echo   9. Manage Built-in apps and restore old ones      บCบ Remove Contact Support App  บ
echo  10. Manage TELEMETRY and Data collection Settings  ศอน            9=^>9             บ
echo  11. Internet Tweaks and Fixes                        ศอออออออออออออออออออออออออออออผ
...
echo   6.Get Office         13.Movies and TV       20.Voice Recorder  27.Store บNo Restoreบ
echo   7.Get Skype          14.News                21.Weather         28.ALL, but store 
echo.
echo   0. Go back to Main page 
echo.
...
if %input% GEQ 1 (
  IF %input% LEQ 29 goto WAfunction
)
...
echo Manage Folders In "This PC" : Manage Folders In "This PC" : 3=^>10
